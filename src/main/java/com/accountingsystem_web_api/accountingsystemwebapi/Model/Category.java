...
public class Category implements Serializable {
    ...
    @ManyToMany(mappedBy = "categoriesResponsible", cascade = CascadeType.ALL, fetch = FetchType.EAGER)
    @OrderBy
    ...
    public Category(String categoryName, List<User> responsibleUsers, List<Category> subCategories) {
        this.categoryName = categoryName;
        this.responsibleUsers = responsibleUsers;
        this.subCategories = subCategories;
    }

    public Category(String categoryName, List<User> responsibleUsers, List<Category> subCategories, Category parentCategory, float overallFinances) {
        this.categoryName = categoryName;
        this.responsibleUsers = responsibleUsers;
        this.subCategories = subCategories;
        this.parentCategory = parentCategory;
    ...
    public String toString() {
        return new CategoryResponse(this).toString();
    }
}
